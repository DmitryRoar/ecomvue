...
import { Alert, Button, ButtonGroup, Card, CardContent, Grid, ToggleButton, ToggleButtonGroup, Typography } from '@mui/material';
    ...
    <Grid item xs={12} sm={3} md={3} sx={{ display: 'block' }}>
      <FeatureContentWrapper>
        ...
        <Grid container spacing={gridSpacing}>
          <Grid item xs={12}>
            <Typography variant="h6" sx={{ fontSize: '1.25rem', fontWeight: 500, position: 'relative', color: theme.palette.primary.main }}>
              {plan.name}
            </Typography>
          </Grid>
          <Grid item xs={12}>
