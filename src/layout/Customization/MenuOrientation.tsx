  ...
  return (
    <Stack direction="row" alignItems="center" pb={2} px={2} justifyContent="space-between" spacing={2.5} sx={{ width: '100%' }}>
      <Typography variant="h5" sx={{ textTransform: 'uppercase' }}>
        <FormattedMessage id="menu-orientation" />
      </Typography>
      <RadioGroup row aria-label="layout" value={layout} onChange={(e) => onChangeLayout(e.target.value)} name="row-radio-buttons-group">
        <FormControlLabel
