                      ...
                      <Grid item md={8}>
                        ...
                        >
                          <Grid item xs={4}>
                            ...
                            >
                              <ListItemButton disableRipple component={Link} href="/apps/user/social-profile/posts">
                                <ListItemIcon>
                                  <FiberManualRecordIcon sx={{ fontSize: '0.5rem' }} />
                                </ListItemIcon>
                                <ListItemText primary="Social Profile" />
                              </ListItemButton>
                              <ListItemButton component={Link} href="/apps/user/account-profile/profile1">
                                <ListItemIcon>
                                  <FiberManualRecordIcon sx={{ fontSize: '0.5rem' }} />
                                </ListItemIcon>
                                <ListItemText primary="Account Profile" />
                              </ListItemButton>
                              <ListItemButton component={Link} href="/apps/user/card/card1">
                                <ListItemIcon>
                                  <FiberManualRecordIcon sx={{ fontSize: '0.5rem' }} />
                                </ListItemIcon>
                                <ListItemText primary="User Cards" />
                              </ListItemButton>
                              <ListItemButton component={Link} href="/apps/user/list/list2">
                                <ListItemIcon>
                                  <FiberManualRecordIcon sx={{ fontSize: '0.5rem' }} />
                                </ListItemIcon>
                                <ListItemText primary="User List" />
                              </ListItemButton>
                              <ListItemButton component={Link} href="/apps/contact/c-card">
                                <ListItemIcon>
                                  <FiberManualRecordIcon sx={{ fontSize: '0.5rem' }} />
                                </ListItemIcon>
                          ...
                          <Grid item xs={4}>
                            ...
                            >
                              <ListItemButton component={Link} href="/apps/chat">
                                <ListItemIcon>
                                  <FiberManualRecordIcon sx={{ fontSize: '0.5rem' }} />
                                </ListItemIcon>
                                <ListItemText primary="Chat" />
                              </ListItemButton>
                              <ListItemButton component={Link} href="/apps/kanban/board">
                                <ListItemIcon>
                                  <FiberManualRecordIcon sx={{ fontSize: '0.5rem' }} />
                                </ListItemIcon>
                                <ListItemText primary="Kanban" />
                              </ListItemButton>
                              <ListItemButton component={Link} href="/apps/mail">
                                <ListItemIcon>
                                  <FiberManualRecordIcon sx={{ fontSize: '0.5rem' }} />
                                </ListItemIcon>
                              ...
                              <ListItemButton component={Link} href="/apps/e-commerce/products">
                                <ListItemIcon>
                                  <FiberManualRecordIcon sx={{ fontSize: '0.5rem' }} />
                                </ListItemIcon>
