  ...
  return (
    <>
      ...
      <Stack direction="row" justifyContent="center" spacing={2}>
        ...
        <Link
          href={`https://oauth.vk.com/authorize?client_id=${process.env.NEXT_PUBLIC_VK_CLIENT_ID}&redirect_uri=${WindowRef.origin}/auth/media/${SocialMediaType.vk_auth}&display=page&response_type=code`}
        >
          <RRSvgIcon height={24} width={24} name="vk" prefix="social" />
        </Link>
        <Link
          href={`https://oauth.mail.ru/login?client_id=${process.env.NEXT_PUBLIC_MAIL_RU_CLIENT_ID}&response_type=code&scope=userinfo&redirect_uri=${WindowRef.origin}/auth/media/${SocialMediaType.mail_ru_auth}&state=some_state`}
        >
