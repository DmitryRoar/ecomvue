          ...
          <Grid item xs={12}>
            <PageContentWrapper>
              <Grid container spacing={gridSpacing}>
                <Grid item xs={12}>
                  <Typography variant="h1">Скоро начнём</Typography>
                </Grid>
                <Grid item xs={12}>
                  <Typography variant="body1">
                    Готовим удобный сервис для роста продаж на маркетплейсах и аналитике. Оставьте свою почту и получите максимальную скидку
                  </Typography>
                </Grid>
              </Grid>
            </PageContentWrapper>
